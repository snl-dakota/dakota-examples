...
This example demonstrates a scatter plot of data from the Rosenbrock curve.  The scatter plot was produced using Dakota GUI.
...
- Choose "Scatter Plot" from the "Plot Type" dropdown menu.
- Choose the data for the X and Y axes from the respective dropdown menus.  In the screenshot above, we used "x1" for X and "response_fn_1" for Y.
- You can optionally specify the plot's title or the color of the trace.
